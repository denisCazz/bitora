    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-zinc-900/50 border border-white/10 space-y-6">
        ...
        <details className="group">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-sm font-medium text-gray-300">Quantità password</label>
                <input
                  type="number"
                  min="1"
                  max="50"
      ...
      <div className="p-4 rounded-xl bg-indigo-500/10 border border-indigo-500/20">
        <p className="text-sm text-indigo-300">
          <strong>🔒 Sicurezza:</strong> Le password vengono generate interamente nel tuo browser usando l'API <code className="text-indigo-200 bg-indigo-500/20 px-1.5 py-0.5 rounded">crypto.getRandomValues()</code>. Nessun dato viene inviato al server.
        </p>
      </div>
    </div>
  );
